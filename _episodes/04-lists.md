...
In the previous episode, we analyzed a single file of wave height data. Let's now look at analysing multiple files, 
for example to look at data over a set of different regions or times.
